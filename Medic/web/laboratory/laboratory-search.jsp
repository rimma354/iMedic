...
<html>
    ...
    <body>
        ...
        <div class="container" >
            <form class="form-horizontal" action="laboratory-search.jsp" >
            ...
            <table  class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a href="laboratory-patient.jsp?id=<%=somePatient.getIdPatient()%>">View</a> </td>
                    </tr>
                    <%
                        }
                    %>
            ...
            <table  class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a href="laboratory-patient.jsp?id=<%=patient.getIdPatient()%>">View</a> </td>
                    </tr>
